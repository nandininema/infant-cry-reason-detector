...
setwd("F:\\mid eval minor 2018\\training_wav")

####Set the input directory to loop over the wave files
input.dir <-
  "F:\\mid eval minor 2018\\training_wav"
...
write.table(mfcc.data.all, file = paste("F:\\mid eval minor 2018\\training_dataset_svm\\train_mean_and_sd_of_coff.csv"),
